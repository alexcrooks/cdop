...
<tr><td>WC</td><td>Engaged in whole class discussion (by offering explanations, opinion, judgment, etc. to whole class)</td></tr>
...
<tr><td>RtW</td><td>Real time writing (board, doc. projector, etc.)</td></tr>
...
<tr><td>N</td><td>Nothing - no activity while waiting for activity to complete, etc.</td></tr>
<tr><td>O</td><td>Other - explain in comments</td></tr>
</table>
</td>
</td>
...
<table id="showHideLegend" class="hideonprint"><tr><td onclick="$('#legend').toggle();">Click here to show/hide the legend.</td></tr></table>
